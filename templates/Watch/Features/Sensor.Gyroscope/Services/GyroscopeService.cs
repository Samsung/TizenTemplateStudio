...
namespace Param_RootNamespace.Services
{
    ...
    public class GyroscopeService : IDisposable
    {
        private Gyroscope _sensor;
        ...
        /// </summary>
        private void OnSensorDataUpdated(object sender, GyroscopeDataUpdatedEventArgs e)
        {
            // TODO: Handle sensor data
            // More details at https://docs.tizen.org/application/dotnet/guides/location-sensors/device-sensors#gyroscope
            Logger.Info($"Gyroscope: {e.X}, {e.Y}, {e.Z}");
        }
    }
}
